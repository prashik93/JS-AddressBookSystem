...
//     get address() { return this._address; }
//     set address(address) {
//         // let addressRegex = RegExp('^[A-Z][a-z]{2,}$');
...
//     get city() { return this._city; }
//     set city(city) {
//         // let cityRegex = RegExp('^[A-Z][a-z]{2,}$');
...
//     get state() { return this._state; }
//     set state(state) {
//         // let stateRegex = RegExp('^[A-Z][a-z]{2,}$');
...
// try {
//     let newAddressBookContact = new ContactDetails("k", "Kamble", "Sanglood", "Akola", "Maharashtra", "444 102", "91 8806187589", "pr@gmail.com");
//     console.log(newAddressBookContact.toString());
// } catch(e) {
//     console.error(e);
// }